...
<aside>
These guidelines are intended for participants in 2022 GDSC Open-source Initiative: https://gdsc.community.dev/e/mndaxe/
</aside>
...
We also welcome any feedback or concern. Feel free to contact us at [GDSC UTM Discord server](https://discord.gg/AZyYSGbU68)!

# Setup your repo with Git

Getting the projects' source code on your local machine is the very first start. We will use Git (version control system) to maintain our projects' code stream.
...
For projects participating in the Open Source Initiative, the main branch is `dev/gdsc-open-source-2022`, so please make sure that your code is always synced with that branch in our main project (not your forked one). To do so, we recommend some git commands:
...
In case you have any questions or concerns, or you want us to review your issue/PR, please contact us via discord at the [GDSC UTM Discord server](https://discord.gg/AZyYSGbU68)!
